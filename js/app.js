...
var collegeStates = prompt('Did I go to college in both California and Oregon?');
...
else {collegeStatesBoolean = false};
console.log('College States is ' + collegeStatesBoolean);
if (collegeStatesBoolean === true){alert('You are correct about me going to college in both California and Oregon.  I began and graduated from Claremont McKenna College but attended the University of Oregon my sophomore year and winter term of my senior year completing my degree in March, 1985')
         }  
else {alert('I did go to college in both California and Oregon.   I began and graduated from Claremont McKenna College but attended the University of Oregon my sophomore year and winter term of my senior year completing my degree in March, 1985')
}
...
if (teacher.toLocaleLowerCase() !== 'yes' && teacher.toLocaleLowerCase() !== 'y' && teacher.toLocaleLowerCase() !== 'no' && teacher.toLocaleLowerCase() !== 'n'  ){
    console.log('teacher if the answer was inappropriate ' + teacher);
     var teacher =  prompt('Please enter yes/no');
...
var pole = prompt('Do I use a 5 weight fishing pole to fly fish for trout?');
console.log(pole);
if (pole.toLowerCase() !== 'yes' && pole.toLowerCase() !== 'y' 
    && pole.toLowerCase() !== 'no' && pole.toLowerCase() !== 'n')
    { prompt('Please enter \'yes\' or \'no\'')}
else {
    if (pole.toLowerCase() === 'yes' || pole.toLowerCase() === 'y') 
         {alert('It is a common misconception that fly fishermen use fishing poles but they actually use fishing rods.  I do use a 5 weight fly rod when fishing for trout');}
