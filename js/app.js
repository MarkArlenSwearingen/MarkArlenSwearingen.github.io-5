...
while(!name){var name = prompt('Please enter your name');
}
...
var goodAnswer = ['yes', 'no', 'y', 'n', 'YES', 'NO', 'Y', 'N'];  //Defind global goodAnswer array.
...
while(!goodAnswer.includes(teacher)){var teacher = prompt('Was I ever a teacher? yes/no');}
...
while(!goodAnswer.includes(pole)){var pole = prompt('Do I use a 5 weight fishing pole to fly fish for trout? yes/no');
...
//var guessNumber = 0;
var i = 0;
while ( favoriteNumber === favoriteNumberGuess && i < 4);{
  if (favoriteNumber === favoriteNumberGuess){alert('You are correct! My favorite number is ' + favoriteNumber);
    i++;
    if (favoriteNumber < favoriteNumberGuess){favoriteNumberGuess = prompt('Please guess another number lower than ' + favoriteNumberGuess);
    }else{favoriteNumberGuess = prompt('Please guess another number higher than ' + favoriteNumberGuess);
    }
  }
}
